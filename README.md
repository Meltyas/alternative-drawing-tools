...
| Hand | `H` | Pan the map |
| Select / move | `1` / `V` | Click to select, drag to move, `Del` to delete |
...
Plus undo (`Ctrl+Z`), delete-all, and a styles panel (colors, width, opacity, smoothing, sketchy style, above-tokens).
